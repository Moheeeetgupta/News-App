    ...
    public static ArrayList<Earthquake> extractEarthquakes(String SAMPLE_JSON_RESPONSE) {
        ...
        try {
            ...
            for(int i=0;i<features.length ();i++){
                ...
                double mag=2.00;
                String place=details.getString ("webTitle");
                long  timeInMillis=162332557;
                String Link=details.getString ("webUrl");
                earthquakes.add(new Earthquake (mag,place,timeInMillis,Link));
            }
